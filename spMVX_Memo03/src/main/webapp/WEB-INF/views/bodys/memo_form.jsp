...
<section>
	<!-- form에서 파일을 업로드 하려면 반드시 enctype을 multipart/form-data로 설정해줘야함 -->
	<form action=<c:url value="/memo_file"/> enctype="multipart/form-data" method="POST">
		...
		<input value="${LOGIN_INFO.m_userid}" readonly id="m_auth" name="m_auth"><br/>
		
		<label for="m_auth">작성자</label>
		<input value="${LOGIN_INFO.m_name}" readonly><br/>
