...
<button class="btn btn-primary" id="btn-drag">글쓰기(drag)</button>
<button class="btn btn-primary" id="btn-tag">글쓰기(tag)</button>
<script
	src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script>
	$(function(){
		$("#btn-drag").click(function(){
			location.href = "<c:url value = '/bbs/drag' />"
		})
		...
		$(".bbs_row").click(function(){
			...
			location.href = "<c:url value = '/bbs/view' />" 
						+ "?id=" 
						+ id
		})
