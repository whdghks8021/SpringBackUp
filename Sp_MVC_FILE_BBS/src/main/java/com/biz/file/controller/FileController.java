...
public class FileController {
	 ...
	 * String(문자열)을 return 하면
	 * WEB-INF/views/문자열.jsp 파일을 찾아 읽어서 렌더링한 후
	 * client에게 전송한다.
	 * 
	 * 또한
	 ...
	 * 
	 * 그리고,
	 * jackson-bind를 Dependency에 추가해 주게 되면
	 * @ResponseBody는 String 뿐만 아니라
	 * List나 사용자가 직접 생성한 클래스 type을 return 할 수 있고,
	 * 해당하는 내용은 적절하게 변환되어 json 형태로
	 * client에게 전송된다.
	 */
