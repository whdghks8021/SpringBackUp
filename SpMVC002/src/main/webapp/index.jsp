	...
	<div id="section">
		...
		<form action="/sp002/join.jsp">
			<!--
				...
				label tag for 속성은 어떤 input tag를 감쌀것인지
				나타내는 값이다.
			...
			<!--
				...
				label tag로 input tag를 감싸는 구조로 만들어도 된다.
				이때는 tag를 tag가 감싸고 있는형태가 되어
				문법적인 문제로 layout이 무너지는 현상을 겪을수도 있다. 
			 -->
			<label>이름 
				<input id="userName" name="userName" /></label><br />
